...
translate("Preload the domain name (GFW mode only,Solve the problem that the terminal fails to access the website in the list after ShadowSocksR Plus+ restart or switch node)"))
o:depends("run_mode","gfw")
o.default=1
